...
const { createUser, loginUserCtrl, getallUser, getaUser, DeleteaUser, updateaUser, blockUser, unblockUser, handleRefreshToken, logoutauser, updatePassword, forgotPasswordToken } = require("../controller/userCtrl");
